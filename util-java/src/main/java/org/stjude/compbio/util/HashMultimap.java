...
/**
 * HashMap-based Multimap implementation
 *
 * @param <K> key type
 * @param <V> value type
...
implements Multimap<K, V, C> {
	...
	private HashMultimap(Factory<C> factory) {
		super();
	 ...
	 */
	private HashMultimap(HashMultimap<K, V, C> src) {
		super();
	 ...
	 */
	public static <K, V> HashMultimap<K, V, Set<V>> newHashSetInstance() {
		return new HashMultimap<K, V, Set<V>>(new Factory<Set<V>>() {
	 ...
	 */
	public static <K, V> HashMultimap<K, V, TreeSet<V>>
			newTreeSetInstance() {
		return new HashMultimap<K, V, TreeSet<V>>(
	 ...
	 */
	public static <K, V> HashMultimap<K, V, List<V>> newListInstance() {
		return new HashMultimap<K, V, List<V>>(
				new Factory<List<V>>() {
	 ...
	 */
	public static <K, V> HashMultimap<K, V, ArrayList<V>>
	newArrayListInstance() {
		return new HashMultimap<K, V, ArrayList<V>>(
	 ...
	 */
	public static <K, V> HashMultimap<K, V, LinkedList<V>>
	newLinkedListInstance() {
		return new HashMultimap<K, V, LinkedList<V>>(
	 ...
	 * copy goes.
	 */
	public static <K, V, C extends Collection<V>> HashMultimap<K, V, C>
	newCopyInstance(HashMultimap<K, V, C> src) {
		return new HashMultimap<K, V, C>(src);
	}
}
